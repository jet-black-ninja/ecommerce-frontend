...
const commonSlice = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        .addCase(getFeatureImages.fulfilled, (state, action: PayloadAction<{ data: FeatureImage[] }>) => {
        ...
        .addCase(addFeatureImage.fulfilled , (state, action: PayloadAction<{data: FeatureImage}>) =>{
